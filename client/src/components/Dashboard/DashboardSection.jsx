...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchUsers = async() => {
     try {
       ...
       if(res){
          ...
          setLastMonthUsers(res.data.data.lastMonthComments)
    ...
    const fetchPosts = async() => {
      try {
        const res = await axios.get(`/api/v1/post/getAllPosts?limit=${5}`)
        if(res){
    ...
    const fetchComments = async() => {
      try {
        const res = await axios.get(`/api/v1/comment/getAllComments?limit=${5}`)
        if(res){
